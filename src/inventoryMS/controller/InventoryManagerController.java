...
public class InventoryManagerController {
    ...
    public void managerMenu(List<InventoryItem> items, String filename) {
        ...
        do {
            ...
            System.out.println("10. Read account data");
            ...
            switch (choice) {
                ...
                case 6:
                    ...
                    InventoryManager.addManager(newUsername, newPassword);
                    break;
                case 7:
                    System.out.print("Enter manager username to remove: ");
                    String removeUsername = scanner.nextLine();
                    InventoryManager.removeManager(removeUsername);
                    break;
                case 8:
                    ...
                    if (itemToEditPrice != null) {
                        ...
                        while (true) {
                            ...
                            if (scanner.hasNextDouble()) {
                                ...
                                InventoryManager.updateItemPriceInFile(itemToEditPrice, filename);
                    ...
                    if (itemToEditQuantity != null) {
                        ...
                        while (true) {
                            ...
                            if (scanner.hasNextInt()) {
                                ...
                                InventoryManager.updateItemQuantityInFile(itemToEditQuantity, filename);
                ...
                case 10:
                    ...
                    manager.readAccountData("account.txt");
                    break;
